 ...
 */
INDEX_TEMPLATE_ARGUMENTS
auto BPLUSTREE_TYPE::Insert(const KeyType &key, const ValueType &value, Transaction *transaction, bool updated) -> bool {
  Page *page;
  page_id_t pid;
  if(IsEmpty()){
    ...
    cur_page->Init(pid, INVALID_PAGE_ID, leaf_max_size_, buffer_pool_manager_);
 ...
 */
INDEX_TEMPLATE_ARGUMENTS
auto BPLUSTREE_TYPE::Begin() -> INDEXITERATOR_TYPE { return INDEXITERATOR_TYPE(this); }
 ...
 */
INDEX_TEMPLATE_ARGUMENTS
auto BPLUSTREE_TYPE::Begin(const KeyType &key) -> INDEXITERATOR_TYPE { return INDEXITERATOR_TYPE(this, key); }
